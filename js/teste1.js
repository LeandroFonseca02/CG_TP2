...
import CannonDebugRenderer from './teste/cannonDebugRenderer.js'
...
gltfLoader.load(
    ...
    (object) => {
        ...
        console.log(monkeyMesh)
        monkeyMesh.material = normalMaterial
        monkeyMesh.position.x = -2
        monkeyMesh.position.y = 20
        monkeyMesh.scale.set(1,1,1);
        monkeyMesh.geometry.attributes.position.itemSize = 3;
        // console.log(monkeyMesh.children[0].geometry)
        ...
        monkeyBody.addShape(new CANNON.Sphere(0.05), new CANNON.Vec3(-0.32, 0.75, 0.73)) //left eyebrow top
        world.addBody(monkeyBody)
        // const monkeyShape2 = CannonUtils.CreateTrimesh(monkeyMesh.children[0].geometry)
